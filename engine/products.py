...
PRODUCTS = {
    "sigenstor": {
        ...
        "expandable": True,
        "ems": "SigenStor EMS",
        "ems_features": ["Dynamische tarieven", "PV-optimalisatie", "Peak shaving", "Tijdschema's"],
        "integration_protocols": ["Modbus TCP", "RS485", "CAN"],
        "integration_platforms": ["Home Assistant"],
        "integration_score": 3,  # 1-5: 1=gesloten, 5=volledig open
        "modularity_score": 5,   # 1-5: 1=niet uitbreidbaar, 5=zeer modulair
    },
    "byd_hvs": {
        "brand": "BYD HVS",
        "chemistry": "LFP",
        ...
        "three_phase": True,
        "expandable": True,
        "ems": "Via omvormer (SMA, Fronius, Victron, etc.)",
        "ems_features": ["Afhankelijk van omvormer-EMS"],
        "integration_protocols": ["CAN", "RS485"],
        "integration_platforms": ["Home Assistant", "SMA Sunny Portal", "Fronius Solar.web", "Victron VRM"],
        "integration_score": 4,
        "modularity_score": 3,
    },
    "byd_hvm": {
    ...
    "huawei_luna2000": {
        ...
        "three_phase": True,
        "expandable": True,
        "ems": "Huawei FusionSolar",
        "ems_features": ["Dynamische tarieven", "PV-optimalisatie", "Peak shaving", "TOU-schema's", "Export limiting"],
        "integration_protocols": ["Modbus TCP", "Modbus RTU", "MQTT (via dongle)"],
        "integration_platforms": ["FusionSolar App", "Home Assistant (via integratie)"],
        "integration_score": 2,
        "modularity_score": 4,
    },
    "tesla_powerwall3": {
        ...
        "three_phase": False,
        "expandable": True,
        "ems": "Tesla Energy (Autobidder)",
        "ems_features": ["Storm Watch", "Time-Based Control", "PV self-consumption", "Grid services"],
        "integration_protocols": ["Tesla Gateway API (local)"],
        "integration_platforms": ["Tesla App", "Home Assistant (via integratie)"],
        "integration_score": 1,
        "modularity_score": 2,
    },
    "enphase_iq5p": {
        ...
        "three_phase": True,
        "expandable": True,
        "ems": "Enphase IQ Gateway / Enlighten",
        "ems_features": ["PV-optimalisatie", "Storm Guard", "Tijdschema's", "Grid services", "Load management"],
        "integration_protocols": ["REST API (local)", "Sunspec Modbus"],
        "integration_platforms": ["Enlighten App", "Home Assistant (via Enphase integratie)", "IFTTT"],
        "integration_score": 4,
        "modularity_score": 5,
    },
}
    ...
    for n_modules in range(p["min_modules"], p["max_modules"] + 1):
        ...
        for inv_kw in p["inverter_options_kw"]:
            ...
            configs.append({
                ...
                "expandable": p.get("expandable", False),
                "ems": p.get("ems", ""),
                "ems_features": p.get("ems_features", []),
                "integration_protocols": p.get("integration_protocols", []),
                "integration_platforms": p.get("integration_platforms", []),
                "integration_score": p.get("integration_score", 1),
                "modularity_score": p.get("modularity_score", 1),
            })
    return configs
